...
#define JNI_RecoverSubWallet "(JLjava/lang/String;IJ)J"

static jlong JNICALL RecoverSubWallet(JNIEnv *env, jobject clazz, jlong instance, jstring jChainID,
                                      jint limitGap, jlong jFeePerKb) {
    bool exception = false;
    std::string msgException;
...
static const JNINativeMethod methods[] = {
        ...
        REGISTER_METHOD(RecoverSubWallet),
...
int registerMasterWallet(JNIEnv *env, const std::string &path) {
